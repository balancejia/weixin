...
<script type="text/javascript" src="${BASE}/www/lib/amazeui/amazeui.min.js"></script>
<script type="text/javascript" src="${BASE}/www/lib/amazeui/amazeui.datetimepicker.min.js"></script>
<script type="text/javascript" src="${BASE}/www/js/admin.js"></script>
