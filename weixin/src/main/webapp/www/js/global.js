...
var Smart = {
    ...
    Validator: {
        checkRequired: function(formId) {
            var result = true;
            var fields=$('#' + formId + ' .ext-required');
                fields.each(function() {
                    ...
                    if (tagName == 'INPUT' || tagName == 'TEXTAREA') {
                        if (value == '') {
                            ...
                            $(this).parent().parent().find('span').addClass('am-icon-times');
                            result = false;
                        } else {
                        	$(this).parent().parent().removeClass('am-form-error');
                        	$(this).parent().parent().find('span').removeClass('am-icon-times');
                        }
                ...
                .change(function() {
                    ...
                    if (tagName == 'INPUT' || tagName == 'TEXTAREA') {
                        if (value != '') {
                            ...
                            $(this).parent().parent().find('span').addClass('am-icon-check');
                        } else {
                        	$(this).parent().parent().removeClass('am-form-success');
                            $(this).parent().parent().find('span').removeClass('am-icon-check');
                            $(this).parent().parent().addClass('am-form-error');
                            $(this).parent().parent().find('span').addClass('am-icon-times');
                        }
                    } else if (tagName == 'SELECT') {
